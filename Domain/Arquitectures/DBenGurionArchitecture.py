...
class DBenGurionArchitecture(object):
    def __init__(self, image_input, batch_size, layers_metaData, initWeights, srng,no_channels_imageInput=1,isTraining=1,pDropOut=0.5):
        """
        ...
        self.DO_1 = dropout_layer.DropOutLayer(self.FC_relu_1,srng, (batch_size,layers_metaData['DO1_size_in']),isTraining,pDropOut)
